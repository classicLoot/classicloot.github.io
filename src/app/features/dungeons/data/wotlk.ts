...
export const wotlkDungeons: dungeon[] = [
    ...
    },
    {
        ...
        bosses: [
            ...
            {
                name: 'Confessor Paletress', loot: [47181, 47218, 47185, 47217, 47177, 47178, 47211, 47176, 47212, 47219, 47213, 47214, 47241, 47498, 47496, 47245, 47497, 47514, 47510, 47495, 47511, 47494, 47512, 47500, 47522, 44990], lootHeroic: []
            },
            {
                name: 'Eadric the Pure', loot: [47181, 47185, 47210, 47177, 47202, 47178, 47176, 47197, 47201, 47199, 47200, 47213, 47241, 47501, 47496, 47498, 47504, 47497, 47502, 47495, 47503, 47494, 47500, 47509, 47508, 44990], lootHeroic: []
            },
            {
    ...
    },
    {
        ...
        bosses: [
            {
                name: 'Bronjahm', loot: [49788, 49785, 49786, 49787, 49784, 49783, 50317, 50316, 50193, 50197, 50194, 50196, 50191, 50169, 50317, 50316], lootHeroic: []
            },
            {
    ...
    },
    {
        ...
        bosses: [
            {
                name: 'Garfrost', loot: [49805, 49806, 49804, 49803, 49802, 49801, 50233, 50234, 50230, 50229, 50228, 50227], lootHeroic: []
            },
            {
                name: 'KrickIck', loot: [49809, 49810, 49811, 49808, 49812, 49807, 50266, 50263, 50264, 50265, 50235, 50262], lootHeroic: []
            },
            {
    ...
    },
    {
        ...
        bosses: [
            {
                name: 'Falric', loot: [49832, 49828, 49830, 49831, 49829, 49827, 50292, 50293, 50295, 50294, 50290, 50291], lootHeroic: []
            },
            {
                name: 'Marwyn', loot: [49834, 49838, 49837, 49836, 49833, 49835, 50298, 50299, 50300, 50297, 50260, 50296], lootHeroic: []
            },
            {
